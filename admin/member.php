...
$query = "SELECT * FROM tbl_member WHERE account_status = 'member'";
         ...
         <section class="content">
            ...
            <div class="container-fluid">
               <div class="card card-info">
                  <br>
                  <div class="col-md-12">
                     <a href="function/user-add-user.php" class="btn btn-success -3">Add User</a>
                           ...
                           if ($query_run) {
                              while ($row = mysqli_fetch_array($query_run)) {
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <img src="../asset/img/profile/<?php echo $row['profile_picture']; ?>" width="150"
                                    ...
                                    <td>
                                       <form action="../admin/function/user-other-action.php" method="post">
                                          <input type="hidden" name="member_id" value="<?php echo $row['member_id'] ?>">
                                          <input type="submit" name="edit" class="btn btn-success" value="EDIT"></input>

                                       </form>
                                       <form action="../admin/function/user-actions.php" onclick="return confirm('Are you sure you want to delete this Member?');" method="post">
                                          <input type="hidden" name="member_id" value="<?php echo $row['member_id'] ?>">
